...
TOKEN = '8150713241:AAGNUlr6XhFkjK4HeYzZF2nLS5gVFCzdcCs'
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @JannuGamingYT* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @JannuGamingYT* 🙏"  # Contact owner message
    else:
